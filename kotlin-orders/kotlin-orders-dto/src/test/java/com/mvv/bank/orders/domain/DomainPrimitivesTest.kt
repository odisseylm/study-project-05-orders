...
internal class DomainPrimitivesTest {
    ...
    fun validateEmail() {
        SoftAssertions().apply {
            ...
            assertThatCode { Email.valueOf(" ") }.hasMessage("Email cannot be null/blank.")
    ...
    fun validatePhone() {
        SoftAssertions().apply {
            ...
            assertThatCode { Phone.valueOf(" ") }.hasMessage("Phone number cannot be null/blank.")
